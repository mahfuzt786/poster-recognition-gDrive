...
if __name__ == "__main__":
    #app.run(debug=True)
    app.run(port=8995, host='0.0.0.0', debug=True, ssl_context='adhoc')
    #context = ('/home/alegra6/ssl/certs/alegralabs_com_d96af_58d91_1591315199_0da5143295f767390931df36da213a28.crt', '/home/alegra6/ssl/keys/d96af_58d91_801552627a6c0af4859605670a97f4f2.key') #certificate and key files
